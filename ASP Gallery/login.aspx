<%@ Page Title="" Language="C#" MasterPageFile="~/connected.Master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ASP_Gallery.WebForm4" %>
                ...
                <div class=" has-text-centered card" style="top: 92px; bottom: 92px;">
                    ...
                    <div class="field">
                        <div class="control has-icons-left has-icons-right">
                            ...
                            <asp:TextBox ID="username" class="input" type="text" placeholder="Username" runat="server" OnTextChanged="username_TextChanged"></asp:TextBox>
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <asp:TextBox ID="password" class="input" type="password" placeholder="Password" runat="server" OnTextChanged="password_TextChanged"></asp:TextBox>
